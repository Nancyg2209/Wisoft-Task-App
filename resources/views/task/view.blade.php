...
task_view->department->id :  {{ $task_view->department->id }} <br>
task_view->t->department_name: {{ $task_view->department->department_name }}  <br>
...
<div class="col-md-4">
    <div class="panel panel-jc">
        <div class="panel-heading">Departmentt</div>
        <div class="panel-body">
            <span class="label label-jc">
                <a href="{{ route('task.list', [ 'departmenid' => $task_view->department->id ]) }}">{{ $task_view->department->department_name }}</a>
            </span>
        </div>
    </div>
