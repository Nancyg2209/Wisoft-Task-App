...
<form id="task_form" action="{{ route('task.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label>Assign to Department <span class="glyphicon glyphicon-pushpin" aria-hidden="true"></span></label>
            <select name="department_id" class="selectpicker" data-style="btn-primary" style="width:100%;">
