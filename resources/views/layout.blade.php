            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="{{ route('department.show') }}"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Departments</a>
                        </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('department.show') }}"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> All Departments</a></li>
                                <li><a href="{{ route('department.create') }}"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Create new Department</a></li>
                            </ul>
                        </li>
                        -->

                        <li>
                            <a href="{{ route('center.show') }}"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Centers</a>
                        </li>

                        <!--
                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle">Centers <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('center.show') }}"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> All Departments</a></li>
                                <li><a href="{{ route('center.create') }}"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Create new Center</a></li>
                            </ul>
                        </li>
